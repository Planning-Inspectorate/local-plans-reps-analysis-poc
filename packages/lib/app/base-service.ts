import { initDatabaseClient } from '@pins/local-plans-reps-analysis-poc-database';
...
export class BaseService {
	 ...
	 * Alias of dbClient
	 *
	 * @returns {import('@pins/local-plans-reps-analysis-poc-database/src/client/client.ts').PrismaClient}
	 */
	get db() {
