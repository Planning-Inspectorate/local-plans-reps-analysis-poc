...
import { createMockPrompt, createMockUser } from '@pins/service-name-lib/data/database/prompts-client.test.ts';
import type { AddPromptViewModel } from '../add/interface.d.ts';
import type { PromptWithLatest } from '@pins/service-name-lib/data/interface.ts';
